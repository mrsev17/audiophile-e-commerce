...
export const IconFacebook = ({ width = 24, height = 24, color = '#FFFFFF' }: IconProps) => {
  return (
    <svg
      width={`${width}`}
      height={`${height}`}
